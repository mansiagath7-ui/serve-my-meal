      ...
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="relative h-48 flex items-center justify-center">
          ...
          <div className="relative flex items-center gap-4">
            <UtensilsCrossed className="w-16 h-16 text-orange-200 -rotate-12 animate-bounce" style={{ animationDelay: '0.2s' }} />
            <ChefHat className="w-32 h-32 text-orange-500 drop-shadow-2xl animate-bounce" />
            <UtensilsCrossed className="w-16 h-16 text-orange-200 rotate-12 animate-bounce" style={{ animationDelay: '0.4s' }} />
          </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-500 text-lg">
            It seems the dish you're looking for was never prepared or has been removed from the kitchen.
          </p>
        </div>
        ...
        <p className="text-sm text-gray-400 font-medium pt-8">
          Need help? <a href="#" className="text-orange-500 hover:underline">Contact the head chef</a>
        </p>
      </div>
    </div>
  );
